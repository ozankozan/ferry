...
<head>
    ...
    <!-- CSS - REQUIRED - START -->
    <!-- Batch Icons -->
    <link rel="stylesheet" href="assets/css/batch-icons.css">
    <!-- Bootstrap core CSS -->
    ...
    <!-- CSS - DEMO - START -->
    <link rel="stylesheet" href="assets/css/ui-icons-batch-icons.css">
    <!-- CSS - DEMO - END -->
            ...
            <div class="row mx-0">
                <div class="col-md-7 order-md-2 signin-right-column px-5 bg-dark" data-qp-bg-image="bg-image-1.jpg">
                    <a class="signin-logo d-sm-block d-md-none" href="#">
                        <img src="https://www.kerkiproduction.com/img/harbiye.jpg" width="145" height="32.3" alt="QuillPro">
                    </a>
